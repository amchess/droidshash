/*
    ...
    Copyright (C) 2011-2014  Peter Österlund, amchesssterlund2@gmail.com
...
import org.amchess.droidshash.activities.CPUWarning;
import org.amchess.droidshash.activities.EditBoard;
import org.amchess.droidshash.activities.EditOptions;
import org.amchess.droidshash.activities.EditPGNLoad;
import org.amchess.droidshash.activities.EditPGNSave;
import org.amchess.droidshash.activities.LoadFEN;
import org.amchess.droidshash.activities.LoadScid;
import org.amchess.droidshash.activities.util.PGNFile;
import org.amchess.droidshash.activities.util.PGNFile.GameInfo;
import org.amchess.droidshash.activities.Preferences;
import org.amchess.droidshash.book.BookOptions;
import org.amchess.droidshash.engine.DroidComputerPlayer.EloData;
import org.amchess.droidshash.engine.EngineUtil;
import org.amchess.droidshash.engine.UCIOptions;
import org.amchess.droidshash.gamelogic.DroidChessController;
import org.amchess.droidshash.gamelogic.ChessParseError;
import org.amchess.droidshash.gamelogic.Game;
import org.amchess.droidshash.gamelogic.Move;
import org.amchess.droidshash.gamelogic.Position;
import org.amchess.droidshash.gamelogic.TextIO;
import org.amchess.droidshash.gamelogic.GameTree.Node;
import org.amchess.droidshash.gamelogic.TimeControlData;
import org.amchess.droidshash.tb.Probe;
import org.amchess.droidshash.tb.ProbeResult;
import org.amchess.droidshash.view.MoveListView;
import org.amchess.droidshash.view.ChessBoard.SquareDecoration;
...
public class DroidShash extends Activity
    ...
    private static String bookDir = "DroidShash/book";
    private static String pgnDir = "DroidShash/pgn";
    private static String fenDir = "DroidShash/epd";
    private static String engineDir = "DroidShash/uci";
    private static String engineLogDir = "DroidShash/uci/logs";
    private static String gtbDefaultDir = "DroidShash/gtb";
    private static String rtbDefaultDir = "DroidShash/rtb";
...

        {
            ...
            addAction(new UIAction() {
                ...
                public void run() {
                    ...
                    Intent i;
                    if (currFT == FT_PGN) {
                        i = new Intent(DroidShash.this, EditPGNLoad.class);
                        i.setAction("org.amchess.droidshash.loadFilePrevGame");
                        i.putExtra("org.amchess.droidshash.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_SCID) {
                        i = new Intent(DroidShash.this, LoadScid.class);
                        i.setAction("org.amchess.droidshash.loadScidPrevGame");
                        i.putExtra("org.amchess.droidshash.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_FEN) {
                        i = new Intent(DroidShash.this, LoadFEN.class);
                        i.setAction("org.amchess.droidshash.loadPrevFen");
                        i.putExtra("org.amchess.droidshash.pathname", currPathName);
            ...
            addAction(new UIAction() {
                ...
                public void run() {
                    ...
                    if (currFT == FT_PGN) {
                        i = new Intent(DroidShash.this, EditPGNLoad.class);
                        i.setAction("org.amchess.droidshash.loadFileNextGame");
                        i.putExtra("org.amchess.droidshash.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_SCID) {
                        i = new Intent(DroidShash.this, LoadScid.class);
                        i.setAction("org.amchess.droidshash.loadScidNextGame");
                        i.putExtra("org.amchess.droidshash.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_FEN) {
                        i = new Intent(DroidShash.this, LoadFEN.class);
                        i.setAction("org.amchess.droidshash.loadNextFen");
                        i.putExtra("org.amchess.droidshash.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_FEN);
                    }
                }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        figNotation = Typeface.createFromAsset(getAssets(), "fonts/DroidShashChessNotationDark.otf");
    ...
    protected void attachBaseContext(Context newBase) {
        super.attachBaseContext(DroidShashApp.setLanguage(newBase, false));
    }
    ...
    private Pair<String,String> getPgnOrFenIntent() {
        ...
        try {
            ...
            DroidShashApp.toast(R.string.failed_to_read_pgn_data, Toast.LENGTH_SHORT);
        } catch (SecurityException|IllegalArgumentException e) {
            DroidShashApp.toast(e.getMessage(), Toast.LENGTH_LONG);
        }
    ...
    private void readPrefs(boolean restartIfLangChange) {
        ...
        DroidShashApp.setLanguage(this, restartIfLangChange);
    ...
    private void handleDrawerSelection(DrawerItemId id) {
        ...
        case EDIT_BOARD:
            ...
            break;
        case SETTINGS: {
            Intent i = new Intent(DroidShash.this, Preferences.class);
        ...
        case DRAW:
            if (ctrl.humansTurn()) {
                if (ctrl.claimDrawIfPossible())
                    ...
                    DroidShashApp.toast(R.string.offer_draw, Toast.LENGTH_SHORT);
            }
            break;
        case SELECT_BOOK:
            if (storageAvailable())
    ...
    private void startEditBoard(String fen) {
        Intent i = new Intent(DroidShash.this, EditBoard.class);
        i.setAction(fen);
        ...
        case RESULT_LOAD_PGN:
            if (resultCode == RESULT_OK) {
                try {
                    ...
                    DroidShashApp.toast(getParseErrString(e), Toast.LENGTH_SHORT);
                }
            }
            break;
        case RESULT_SAVE_PGN:
            if (resultCode == RESULT_OK) {
                long hash = data.getLongExtra("org.amchess.droidshash.treeHash", -1);
        ...
        case RESULT_SELECT_SCID:
            if (resultCode == RESULT_OK) {
                ...
                if (pathName != null) {
                    ...
                    editor.apply();
                    Intent i = new Intent(DroidShash.this, LoadScid.class);
                    i.setAction("org.amchess.droidshash.loadScid");
                    i.putExtra("org.amchess.droidshash.pathname", pathName);
                    startActivityForResult(i, RESULT_LOAD_PGN);
                }
            }
            break;
        ...
        case RESULT_EDITOPTIONS:
            if (resultCode == RESULT_OK) {
                ...
                Map<String,String> uciOpts =
                    (Map<String,String>)data.getSerializableExtra("org.amchess.droidshash.ucioptions");
    ...
    private class EloStrengthSetter {
        ...
        public Dialog getDialog() {
            if (!eloData.canChangeStrength()) {
                DroidShashApp.toast(R.string.engine_cannot_reduce_strength, Toast.LENGTH_LONG);
                return null;
            }
            AlertDialog.Builder builder = new AlertDialog.Builder(DroidShash.this);
            builder.setTitle(R.string.set_engine_strength);
            View content = View.inflate(DroidShash.this, R.layout.set_strength, null);
    ...
    private Dialog clipBoardDialog() {
        ...
        builder.setItems(lst.toArray(new String[0]), (dialog, item) -> {
            ...
            case COPY_GAME: {
                ...
                clipboard.setPrimaryClip(new ClipData("DroidShash game",
    ...
    private void shareGameOrText(boolean game) {
        ...
        if (pgn.length() < 32768) {
            ...
            String authority = "org.amchess.droidshash.fileprovider";
    ...
    private Dialog aboutDialog() {
        ...
        try {
            PackageInfo pi = getPackageManager().getPackageInfo("org.amchess.droidshash", 0);
    ...
    private void editHeaders() {
        ...
        View content = View.inflate(DroidShash.this, R.layout.edit_headers, null);
        builder.setView(content);
    ...
    private void editComments() {
        ...
        View content = View.inflate(DroidShash.this, R.layout.edit_comments, null);
        builder.setView(content);
    ...
    private Dialog thinkingMenuDialog() {
        ...
        builder.setItems(lst.toArray(new String[0]), (dialog, item) -> {
            ...
            case COPY_TO_CLIPBOARD: {
                ...
                sb.append(thinkingStr2);
                ClipboardManager clipboard = (ClipboardManager)getSystemService(CLIPBOARD_SERVICE);
                ClipData cd = new ClipData("DroidShash analysis",
    ...
    private class MultiPVSet {
        ...
        public void multiPVDialog(int numPV, int maxPV0) {
            ...
            View content = View.inflate(DroidShash.this, R.layout.num_variations, null);
            builder.setView(content);
    ...
    private void setEngineOptions() {
        Intent i = new Intent(DroidShash.this, EditOptions.class);
        UCIOptions uciOpts = ctrl.getUCIOptions();
        if (uciOpts != null) {
            i.putExtra("org.amchess.droidshash.ucioptions", uciOpts);
            i.putExtra("org.amchess.droidshash.enginename", engineTitleText.getText());
            i.putExtra("org.amchess.droidshash.workDir", engineOptions.workDir);
            boolean localEngine = engineOptions.networkID.isEmpty();
            i.putExtra("org.amchess.droidshash.localEngine", localEngine);
    ...
    private Dialog newNetworkEngineDialog() {
        ...
        final Runnable createEngine = () -> {
            ...
            if (!nameOk) {
                DroidShashApp.toast(errMsg, Toast.LENGTH_LONG);
                reShowDialog(NETWORK_ENGINE_DIALOG);
                return;
            }
    ...
    private void savePGNToFile(String pathName) {
        ...
        editor.apply();
        Intent i = new Intent(DroidShash.this, EditPGNSave.class);
        i.setAction("org.amchess.droidshash.saveFile");
        i.putExtra("org.amchess.droidshash.pathname", pathName);
        i.putExtra("org.amchess.droidshash.pgn", pgnToken);
    ...
    private void setEditPGNBackup(Intent i, String pathName) {
        ...
        i.putExtra("org.amchess.droidshash.backup", backup);
    }
    ...
    private void loadPGNFromFile(String pathName, boolean updateCurrFile) {
        ...
        Intent i = new Intent(DroidShash.this, EditPGNLoad.class);
        i.setAction("org.amchess.droidshash.loadFile");
        i.putExtra("org.amchess.droidshash.pathname", pathName);
        i.putExtra("org.amchess.droidshash.updateDefFilePos", updateCurrFile);
        setEditPGNBackup(i, pathName);
        startActivityForResult(i, RESULT_LOAD_PGN);
    }
    ...
    private void loadFENFromFile(String pathName) {
        ...
        editor.apply();
        Intent i = new Intent(DroidShash.this, LoadFEN.class);
        i.setAction("org.amchess.droidshash.loadFen");
        i.putExtra("org.amchess.droidshash.pathname", pathName);
        startActivityForResult(i, RESULT_LOAD_FEN);
    }
    ...
    public void reportInvalidMove(Move m) {
        ...
        DroidShashApp.toast(msg, Toast.LENGTH_SHORT);
    }
    ...
    public void reportEngineError(String errMsg) {
        ...
        DroidShashApp.toast(msg, Toast.LENGTH_LONG);
    }
