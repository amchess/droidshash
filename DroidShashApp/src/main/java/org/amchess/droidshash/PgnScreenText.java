/*
    ...
    Copyright (C) 2019  Peter Österlund, amchesssterlund2@gmail.com
...
import org.amchess.droidshash.gamelogic.PgnToken;
...
class PgnScreenText implements PgnToken.PgnTokenReceiver,
    ...
    PgnScreenText(DroidShash df, PGNOptions options) {
        this.df = df;
