...
package org.amchess.droidshash.book;
...
import org.amchess.droidshash.gamelogic.GameTree;
...
public class EcoDb {
    ...
    private EcoDb() {
        ...
        try (ByteArrayOutputStream bufStream = new ByteArrayOutputStream();
             InputStream inStream = DroidShashApp.getContext().getAssets().open("eco.dat")) {
