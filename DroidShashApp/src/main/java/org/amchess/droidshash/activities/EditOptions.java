...
import org.amchess.droidshash.activities.util.FileBrowseUtil;
import org.amchess.droidshash.databinding.EditoptionsBinding;
import org.amchess.droidshash.databinding.UciOptionButtonBinding;
import org.amchess.droidshash.databinding.UciOptionCheckBinding;
import org.amchess.droidshash.databinding.UciOptionComboBinding;
import org.amchess.droidshash.databinding.UciOptionSpinBinding;
import org.amchess.droidshash.databinding.UciOptionStringBinding;
...
public class EditOptions extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        uciOpts = (UCIOptions) i.getSerializableExtra("org.amchess.droidshash.ucioptions");
        engineName = (String) i.getSerializableExtra("org.amchess.droidshash.enginename");
        workDir = (String) i.getSerializableExtra("org.amchess.droidshash.workDir");
        hasBrowser = (Boolean) i.getSerializableExtra("org.amchess.droidshash.localEngine");
        if (uciOpts != null) {
            if (hasBrowser)
    ...
    private void sendBackResult() {
        if (uciOpts != null) {
            ...
            Intent i = new Intent();
            i.putExtra("org.amchess.droidshash.ucioptions", uciMap);
