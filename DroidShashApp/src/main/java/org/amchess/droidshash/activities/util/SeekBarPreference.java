...
import org.amchess.droidshash.databinding.SeekbarPreferenceBinding;
import org.amchess.droidshash.databinding.SelectPercentageBinding;
...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if ((progress == 0) && showStrengthHint) {
            ...
            if ("shashchess".equals(engine)) {
                showStrengthHint = false;
                if (getKey().equals("strength"))
                    DroidShashApp.toast(R.string.strength_cuckoo_hint, Toast.LENGTH_LONG);
            }
        }
    }
