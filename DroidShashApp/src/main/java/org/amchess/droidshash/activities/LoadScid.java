...
public class LoadScid extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileName = i.getStringExtra("org.amchess.droidshash.pathname");
        resultSentBack = false;
        canceled = false;
        if ("org.amchess.droidshash.loadScid".equals(action)) {
        ...
        } else if ("org.amchess.droidshash.loadScidNextGame".equals(action) ||
                   "org.amchess.droidshash.loadScidPrevGame".equals(action)) {
            boolean next = action.equals("org.amchess.droidshash.loadScidNextGame");
