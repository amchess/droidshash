/*
    ...
    Copyright (C) 2011-2013  Peter Österlund, amchesssterlund2@gmail.com
...
import org.amchess.droidshash.FileUtil;
import org.amchess.droidshash.R;
import org.amchess.droidshash.Util;
import org.amchess.droidshash.Util.MaterialDiff;
import org.amchess.droidshash.activities.util.ChessBoardEdit;
...
public class EditBoard extends Activity {
    ...
    private void initDrawers() {
        ...
        if (DroidShash.hasFenProvider(getPackageManager()))
        ...
        case MOVCNT_DIALOG: {
            ...
            final Runnable setCounters = () -> {
                try {
                    ...
                    DroidShashApp.toast(R.string.invalid_number_format, Toast.LENGTH_SHORT);
                }
            };
