...
package org.amchess.droidshash.activities.util;
...
public class PGNFile {
    ...
    public void appendPGN(String pgn, boolean silent) {
        ...
        try (FileWriter fw = new FileWriter(fileName, true)) {
            fw.write(pgn);
            if (!silent)
                DroidShashApp.toast(R.string.game_saved, Toast.LENGTH_SHORT);
        } catch (IOException e) {
            DroidShashApp.toast(R.string.failed_to_save_game, Toast.LENGTH_SHORT);
        }
    }
    ...
    public boolean deleteGame(GameInfo gi, ArrayList<GameInfo> gamesInFile) {
        try {
            ...
            DroidShashApp.toast(R.string.failed_to_delete_game, Toast.LENGTH_SHORT);
        }
        return false;
    }
