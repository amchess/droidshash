...
import org.amchess.droidshash.engine.cuckoochess.CuckooChessEngine;
...
public abstract class UCIEngineBase implements UCIEngine {
    ...
    public static UCIEngine getEngine(String engine,
        ...
        else if ("shashchess".equals(engine))
            return new InternalShashChess(report, engineOptions.workDir);
