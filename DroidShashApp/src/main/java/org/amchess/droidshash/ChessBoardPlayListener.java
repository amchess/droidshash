...
public class ChessBoardPlayListener implements View.OnTouchListener {
    ...
    private Runnable runnable = new Runnable() {
        public void run() {
            ...
            df.reShowDialog(DroidShash.BOARD_MENU_DIALOG);
        }
    };

    ChessBoardPlayListener(DroidShash df, ChessBoardPlay cb) {
        this.df = df;
        this.cb = cb;
    }
                ...
                if (df.ctrl.humansTurn()) {
                    ...
                    if (dragSquare != -1) {
                        if (sq != -1 && sq != sq0) {
                            ...
                            df.setAutoMode(DroidShash.AutoMode.OFF);
