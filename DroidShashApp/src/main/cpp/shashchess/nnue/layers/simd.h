...
m512_haddx4(__m512i sum0, __m512i sum1, __m512i sum2, __m512i sum3, __m128i bias) {
...
[[maybe_unused]] static void m512_add_dpbusd_epi32(__m512i& acc, __m512i a, __m512i b) {
    ...
    asm("vpdpbusd %[b], %[a], %[acc]\n\t" : [acc] "+v"(acc) : [a] "v"(a), [b] "vm"(b));
        #else
...
[[maybe_unused]] static __m128i
m256_haddx4(__m256i sum0, __m256i sum1, __m256i sum2, __m256i sum3, __m128i bias) {
...
[[maybe_unused]] static void m256_add_dpbusd_epi32(__m256i& acc, __m256i a, __m256i b) {
    ...
    #if defined(USE_VNNI)
        #if defined(USE_INLINE_ASM)
    asm(VNNI_PREFIX "vpdpbusd %[b], %[a], %[acc]\n\t" : [acc] "+v"(acc) : [a] "v"(a), [b] "vm"(b));
        #else
...
m256_add_dpbusd_epi32x2(__m256i& acc, __m256i a0, __m256i b0, __m256i a1, __m256i b1) {
    ...
    #if defined(USE_VNNI)
        #if defined(USE_INLINE_ASM)
    asm(VNNI_PREFIX "vpdpbusd %[b0], %[a0], %[acc]\n\t" VNNI_PREFIX
                    "vpdpbusd %[b1], %[a1], %[acc]\n\t"
        : [acc] "+&v"(acc)
        : [a0] "v"(a0), [b0] "vm"(b0), [a1] "v"(a1), [b1] "vm"(b1));
        #else
...
[[maybe_unused]] static __m128i
m128_haddx4(__m128i sum0, __m128i sum1, __m128i sum2, __m128i sum3, __m128i bias) {
...
[[maybe_unused]] static int32x4_t
neon_m128_haddx4(int32x4_t sum0, int32x4_t sum1, int32x4_t sum2, int32x4_t sum3, int32x4_t bias) {

    int32x4_t hsums{neon_m128_reduce_add_epi32(sum0), neon_m128_reduce_add_epi32(sum1),
                    neon_m128_reduce_add_epi32(sum2), neon_m128_reduce_add_epi32(sum3)};
