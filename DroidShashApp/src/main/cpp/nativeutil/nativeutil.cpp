...
/*
 * Class:     org_amchess_droidshash_engine_EngineUtil
 * Method:    chmod
 * Signature: (Ljava/lang/String;)Z
 */
extern "C" JNIEXPORT jboolean JNICALL Java_org_amchess_droidshash_engine_EngineUtil_chmod
 ...
 * Signature: (II)V
 */
extern "C" JNIEXPORT void JNICALL Java_org_amchess_droidshash_engine_EngineUtil_reNice
 ...
 * Signature: ()Z
 */
extern "C" JNIEXPORT jboolean JNICALL Java_org_amchess_droidshash_engine_EngineUtil_isSimdSupported
    (JNIEnv *env, jclass) {
#if defined(__arm__)
